...
net_folder     = 'src/training/networks/trained_netrowks/Unet';
...
encoderDepth = 4;
%layer = unet(image_size,numClasses,EncoderDepth=encoderDepth);
%save('src/supervised/UNet/unet_d4.mat', 'lgraph');
loadedData = load('src/supervised/UNet/unet_d4.mat');
layers = loadedData.layer;
...
folder_trained = fullfile(pwd,strcat("src/supervised/UNet/trained_networks",name));
